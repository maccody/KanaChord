...
Attach the three keyboard feet by sliding the attachment pegs into the holes and sliding the feet into the slots.  If desired the the right and left keyboard feet can be glued into place.  It is not recommended to glue the center foot, as doing so would make it difficult to disassembly the keyboard for maintenance or modification.
![keyboard_feet_attached](https://github.com/maccody/KanaChord/assets/17059321/9142edfb-f2ef-4cac-aa37-dc3f590769ca)
